...
#参数
bert_path = '/gpfs1/home/nc/chaixq/cite/huggingface/untitled/ernie_input'   #预训练模型的位置
...
def train_and_eval(model, train_loader, valid_loader, optimizer, schedule, device, epoch):
    ...
    for i in range(epoch):
        ...
        f = codecs.open("/gpfs1/home/nc/chaixq/cite/huggingface/untitled/cite_ernie_predictor_out/acc.json", "w", "utf-8")
...
f = codecs.open("/gpfs1/home/nc/chaixq/cite/huggingface/untitled/cite_ernie_predictor_out/F.json", "w", "utf-8")
...
#print(examples)
workbook = xw.Workbook("/gpfs1/home/nc/chaixq/cite/huggingface/untitled/cite_ernie_predictor_out/test_data.xlsx")
