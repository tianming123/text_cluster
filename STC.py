...
class STC(object):
    ...
    def fit(self, x, y=None, maxiter=2e4, batch_size=256, tol=1e-3,
        ...
        print('更新间隔  ', update_interval)
        save_interval = int(x.shape[0] / batch_size) * 5  # 5 epochs
        print('保存间隔  ', save_interval)

        # Step 1: initialize cluster centers using k-means
        print('初始化k-means的簇中心.')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ae_weights', default='/Users/mac/PycharmProjects/text_cluster/data/stackoverflow/results/ae_weights.h5')
    parser.add_argument('--save_dir', default='/Users/mac/PycharmProjects/text_cluster/data/stackoverflow/results')
